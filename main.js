...
function render(){
    ...
    for(let i=0; i<list.length; i++){
        if(list[i].isComplete == true){
            ...
            <div>
                <button onclick="toggleComplete('${list[i].id}')"><i class="fa-solid fa-backward"></i></button>
            ...
            <div>
                <button onclick="toggleComplete('${list[i].id}')"><i class="fa-regular fa-thumbs-up"></i></button> 
                <button onclick="deleteTask('${list[i].id}')"><i class="fa-solid fa-eraser"></i></button>
            </div>
